      ...
      <div class="row">
        ...
        <div class="col-md-6">
        	...
        	<div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="kode_asset_controller" id="kode_asset_controller" placeholder="Kode Asset Controller" value="{{@$data['content']->KODE_ASSET_CONTROLLER}}" @if($data['editable']['KODE_ASSET_CONTROLLER'] != 1) readonly="1" @endif>
              </div>
            </div>
