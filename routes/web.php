...
Route::get('/get-businessarea', ['as' => 'get.businessarea', 'uses' => 'Select2Controller@businessarea']);
...
Route::post('/approval/update_pic/','ApprovalController@update_pic');
Route::post('/approval/update_jenis_asset/','ApprovalController@update_jenis_asset');
...
Route::get('/outstanding_email','FamsEmailController@kirim_email')->name('outstanding_email');
...
Route::resource('/request', 'RequestAsetLainController')->only([ 'index' ]);
...
Route::get('/approval/attachment-disposal/{id}', 'DisposalController@attachment_disposal');
