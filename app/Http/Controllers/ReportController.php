...
(SELECT SUBGROUP_DESCRIPTION FROM TM_SUBGROUP_ASSET WHERE JENIS_ASSET_CODE = a.JENIS_ASSET AND GROUP_CODE = a.GROUP AND SUBGROUP_CODE = a.SUB_GROUP LIMIT 1) AS SUB_GROUP_NAME, a.DISPOSAL_FLAG AS STATUS_DOCUMENT
